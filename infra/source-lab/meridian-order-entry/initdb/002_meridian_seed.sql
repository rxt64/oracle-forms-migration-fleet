-- Meridian Order Entry source lab: seed rows.
--
-- The block between the markers is reproduced verbatim from ../source/db/seed.sql, comments
-- included, so the lab and the checked-in source fixture stay one estate. Every value is invented
-- for this repository. tests/.../MeridianSourceLabFixtureTests.cs fails if the two ever differ.
